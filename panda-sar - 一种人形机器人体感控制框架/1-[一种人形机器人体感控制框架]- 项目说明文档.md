...
![熊猫飒](4-%5b%e4%b8%80%e7%a7%8d%e4%ba%ba%e5%bd%a2%e6%9c%ba%e5%99%a8%e4%ba%ba%e4%bd%93%e6%84%9f%e6%8e%a7%e5%88%b6%e6%a1%86%e6%9e%b6%5d-+%e8%be%85%e5%8a%a9%e8%b5%84%e6%96%99/%e7%86%8a%e7%8c%ab%e9%a3%92Logo.png)
- 研发团队：熊猫·飒
...
4. 将关节封装到肢体，确定每个肢体都有三个自由度（滚转 Roll 俯仰 Pitch 偏航 Yaw），就能确定它们与各个关节之间的转换关系。
	![机器人肢体运动姿态矩阵](机器人肢体运动姿态矩阵关系图.png)
...
def onDataReceived(self, data: bytes):
	if self.deviceID == bytes(data[:12]).decode('ascii'):
		# 时间
		self.set("Time", "20{}-{}-{} {}:{}:{}.{}".format(data[12], data[13], data[14], data[15], data[16],
														 data[17], (data[19] << 8 | data[18]))
		)
		# 加速度（单位：g）
